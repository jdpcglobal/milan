        ...
        <View>
            <View style={styles.header}>
                <View style={{ flexDirection: 'row', alignItems: 'center', marginLeft: 10 }}>
                    <Image style={styles.img} source={require('../Asset/Images/LogoMinal.png')} />
                    <Text style={{ fontSize: 20, color: 'black', marginLeft: 10, fontWeight: '700' }}>Milan</Text>
                </View>
            </View>
            <View style={{backgroundColor:'white', display: 'flex', alignItems: 'center', marginTop: '10%', paddingTop: '5%', paddingBottom: '10%', borderRadius: 10, marginHorizontal: 10 }}>
                ...
                <View style={styles.detailBox}>
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate('Home')} >
                        ...
                        >
                            <Text style={{ color: 'white', fontSize: 20, fontWeight: '700', padding: 10, fontFamily: 'georgia', textAlign:'center' }}>Back</Text>
                        </LinearGradient>
                    </TouchableOpacity>
                </View>
            </View>
